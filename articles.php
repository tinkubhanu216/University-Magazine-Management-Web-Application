...
<body>
	...
	<div class="header1">
		<center><ul class="headlink2">
			<li class="active1"><a class="active1" href="articles.php" style="padding: 1vw 3.9vw;">Oncampus Article</a></li>
			<li><a class="hh2" href="garticles.php" style="padding: 1vw 3.9vw;">General Article</a></li>
			<li><a class="hh2" href="starticles.php" style="padding: 1vw 3.9vw;">Science & Technology</a></li>
...
<?php
//	$artles = array("", "General Article", "Science & Technology", "Poem", "Silly Points","Telugu");
	$sql = "select *from articles NATURAL JOIN ranking NATURAL JOIN astatus where contenttype='Oncampus Article' and status='accepted' ORDER BY VIEWS DESC";
	$c=1;
