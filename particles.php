...
<body>
	...
	<div class="header1">
		<center><ul class="headlink2">
			...
			<li class="active1"><a class="active1" href="particles.php" style="padding: 1vw 2.9vw;">Poem</a></li>
...
<?php
	$sql = "select *from articles NATURAL JOIN ranking NATURAL JOIN astatus where contenttype='Poem' and status='accepted' ORDER BY VIEWS DESC";
	$c=1;
