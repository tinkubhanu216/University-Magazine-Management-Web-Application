...
<body>
	...
	<div class="header1">
		<center><ul class="headlink2">
			...
			<li class="active1"><a class="active1" href="tarticles.php" style="padding: 1vw 2.9vw;">Telugu</a></li>
		</ul></center>
	</div>
<?php
...
<?php
	$sql = "select *from articles NATURAL JOIN ranking NATURAL JOIN astatus where contenttype='Telugu' and status='accepted' ORDER BY VIEWS DESC";
	$c=1;
