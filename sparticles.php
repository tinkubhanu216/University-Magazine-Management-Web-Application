...
<body>
	...
	<div class="header1">
		<center><ul class="headlink2">
			...
			<li class="active1"><a class="active1" href="sparticles.php" style="padding: 1vw 3.9vw;">Silly Points</a></li>
...
<?php
	$sql = "select *from articles NATURAL JOIN ranking NATURAL JOIN astatus where contenttype='Silly Points' and status='accepted' ORDER BY VIEWS DESC";
	$c=1;
